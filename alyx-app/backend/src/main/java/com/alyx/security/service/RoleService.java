...
public class RoleService {
    ...
    public PagedResponse<RoleDto> findAll(int page, int size, String search) {
        ...
        var p = (search == null || search.isBlank())
            ? roleRepo.findAll(pageable)
            : roleRepo.search(search, pageable);
